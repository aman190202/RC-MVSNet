#!/usr/bin/env python
"""
Copied from https://github.com/alibaba/cascade-stereo/blob/master/CasMVSNet/colmap2mvsnet.py
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_ext', type=str, default=".bin",  choices=[".txt", ".bin"], help='sparse model ext')
        ...
        # … existing arguments …
    parser.add_argument('--minimal_depth',            # ❶ NEW
                        action='store_true',
                        help='If set, write only depth_min and depth_interval '
                            'to each *_cam.txt instead of all four values.')
